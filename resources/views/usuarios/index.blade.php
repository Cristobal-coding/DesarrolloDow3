                ...
                <tr>
                  ...
                  <td>
                    ...
                    <span class="pl-1" data-toggle="tooltip" title="Borrar." data-placement="right">                               
                      <a type="button" class="btn btn-warning @if(Gate::denies('onlyAdmin') || $user->id==Auth::user()->id) disabled @endif" data-bs-toggle="modal" data-bs-target="#borrarUser{{$user->id}}"><i class="fas fa-trash fa-lg"></i></a>
                     </span>  
                     {{-- modal borrar --}}
                     @if(Gate::allows('onlyAdmin') || $user->id==Auth::user()->id) 
                     <div class="modal fade text-light " id="borrarUser{{$user->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-content bg-dark" style="color: #fff;">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <form method="POST" action="{{route("usuarios.destroy",$user->id)}}">
                                          @csrf
                                          @method("delete")
                                          <button type="submit" data-toggle="tooltip" title="Borrar" data-placement="right" class="btn btn-warning">Borrar Usuario</button>
                                      </form>
                                  </div>
                              </div>
                        </div>
